...
let nomeParaBuscar = window.prompt("Pesquise um nome:");

let nomeNoRegistro = registroDasPessoas.find((nomeNoRegistro) => {
  if (nomeParaBuscar === nomeNoRegistro.name) {
    return alert(nomeNoRegistro.name + " foi encontrado");
  }
});
